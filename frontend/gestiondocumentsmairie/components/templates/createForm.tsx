...
export default function CreateTemplatePage() {
  ...
  const [isPreviewMode, setIsPreviewMode] = useState(false) // Mode aperçu activé ou non
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="container mx-auto py-10 px-4 max-w-6xl">
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-slate-900">Créer un nouveau modèle</h1>
            <p className="text-slate-600">Créez un modèle de document avec des variables dynamiques</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Aperçu si activé */}
            {isPreviewMode && contentValue && (
              <Card>
                <CardHeader>
                  <CardTitle><Eye className="h-5 w-5 text-purple-600" /> Aperçu</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="whitespace-pre-line">{contentValue}</div>
                </CardContent>
              </Card>
            )}
