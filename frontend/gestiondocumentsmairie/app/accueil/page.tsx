  ...
  return (
    <div className="relative min-h-screen text-white overflow-hidden font-sans">
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-10">
            {[
              ...
              },
              {
                ...
                desc: "Enregistrement des paiements et génération automatique des reçus.",
        ...
        <section className="bg-gradient-to-br from-cyan-900/60 to-teal-800/60 backdrop-blur-sm rounded-2xl mx-auto p-8 sm:p-12 max-w-6xl shadow-xl mb-16 border border-white/10">
            ...
            {[
              {
                ...
                value: "8,910",
                color: "from-cyan-800/50 to-cyan-700/50",
                borderColor: "border-cyan-400/20",
              ...
              },
              {
                ...
                value: "12,345",
                color: "from-teal-800/50 to-teal-700/50",
                borderColor: "border-teal-400/20",
              ...
              },
              {
                ...
                value: "25",
                color: "from-amber-800/50 to-amber-700/50",
                borderColor: "border-amber-400/20",
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className={`text-center bg-gradient-to-br ${stat.color} rounded-xl p-6 border ${stat.borderColor} backdrop-blur-sm shadow-lg`}
              >
                <h3 className={`text-3xl sm:text-4xl font-bold ${stat.valueColor} mb-2`}>{stat.value}</h3>
